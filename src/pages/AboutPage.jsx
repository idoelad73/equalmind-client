import { Anchor, Flag, MousePointerClick, ShieldCheck, Sparkles } from 'lucide-react'
...
const HOW_IT_WORKS = [
  {
    icon: Anchor,
    term: 'HOOKING',
    body: 'בכל פעם שתיתקל/י בהתנהגות שבעיניך חיובית (או פוגענית ומדירה) כלפיך או כלפי מישהו/י בסביבה, תוכל/י לעשות HOOK ולהצביע עליה ועל האדם או הארגון שאחראי עליה.',
  },
  {
    icon: Sparkles,
    term: 'מה זה HOOK?',
    body: "HOOK הוא פעולת ההצבעה על התנהגות. אנחנו קוראים להם HOOK כי הם הופכים ל'ווי' שעליו א.נשים נעשים מודעים להתנהגויות שלהם — כדי לחזק את החיוביות ולהחליף את הפוגעניות בטובות יותר.",
  },
  {
    icon: MousePointerClick,
    term: '2-3 קליקים וזהו',
    body: 'המערכת תציע לך סוגים שונים של התנהגויות אופייניות לסביבות שונות, ובמספר צעדים קצרים ופשוטים תוכל/י לעשות HOOK.',
  },
  {
    icon: Flag,
    term: 'GREEN FLAGS',
    body: "אנחנו נדאג להרים 'דגלים ירוקים' ולתת משוב לא.נשים ולארגונים שיצברו HOOKS, וגם נציע להם דרכים והתנהגויות להתפתח ולהיות מיטיבים ומיטיבות יותר.",
  },
]

const REASSURANCE = [
  {
    title: 'ה-HOOKS אנונימיים לגמרי',
    body: 'ה-HOOKS שלך יצטרפו ל-HOOKS של אחרות ואחרים ביחס לאדם מסוים. רק אם נזהה דפוס התנהגות קבוע ומתמשך אותו אדם יקבל FLAG — כך שבכל מקרה לא ניתן לזהות מי תרמ/ה HOOK.',
  },
  {
    title: "ה-HOOK'S FLAGS אישיים",
    body: "רק מי שתרמו עליו HOOKS מקבל HOOK'S FLAGS. לא הבוס/ית שלו/ה, לא מנהל/ת אחר/ת ולא כל סמכות אחרת תדע מזה.",
  },
]
